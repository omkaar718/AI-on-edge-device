...
model.load_state_dict(torch.load('segmentation_my_checkpoint.pth.tar', map_location=DEVICE)["state_dict"])
...
def infer_from_file(img_path):
    ...
    print('Shape that goes into model() ', input_image.unsqueeze(0).shape)
...
if __name__ == '__main__':
    infer_from_file('test_multiple_persons.jpeg')
    #infer_from_webcam()